...
digits.for.rounding = 1 # indicate the number of digits to round the data to
...
# flag and details about trimming sample names. likely not needed in most cases, but was in an initial case
trim.sample.name = T
start.trim = 1
stop.trim = 12
